    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6 lg:px-8 relative z-10 pt-32 pb-24">
        ...
        >
          ...
          {/* Overlapping Avatars for Trust */}
          <motion.div
            className="flex items-center justify-center gap-4 mb-10"
            variants={itemVariants}
          >
            <div className="flex -space-x-4">
              <img src="/assets/logo/manager Kanchan.jpg" alt="Client" className="w-12 h-12 rounded-full border-4 border-background object-cover relative z-10" />
              <img src="/assets/logo/reviwe by ceo.jpg" alt="Client" className="w-12 h-12 rounded-full border-4 border-background object-cover relative z-20" />
              <img src="/assets/logo/reviwe marketing manager sojib ahmed.png" alt="Client" className="w-12 h-12 rounded-full border-4 border-background object-cover relative z-30" />
              <img src="/assets/logo/reviwe by ceo.webp" alt="Client" className="w-12 h-12 rounded-full border-4 border-background object-cover relative z-40" />
            </div>
          ...
          >
            <motion.p
              ...
              transition={{ delay: 1 }}
            >
              Trusted by 25+ brands worldwide
            </motion.p>
            <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8">
              {[
                { value: 25, suffix: "+", label: "Shopify Stores" },
                { value: 25, suffix: "+", label: "Facebook Ads Campaigns" },
